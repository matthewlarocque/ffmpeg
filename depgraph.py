...
GRAPH = {'aac_adtstoasc_bsf': {'select': ['adts_header', 'mpeg4audio']},
 ...
 'avcodec': {'deps': ['avutil'],
             'suggest': ['libm', 'stdatomic', 'liblcevc_dec']},
 ...
 'h264_videotoolbox_hwaccel': {'deps': ['videotoolbox'],
                               'select': ['h264_decoder']},
 'h264_vulkan_encoder': {'select': ['cbs_h264', 'vulkan_encode']},
 ...
 'ldbrx': {'deps': ['ppc']},
 'lead_decoder': {'select': ['idctdsp', 'jpegtables']},
 ...
 'mediacodec': {'deps': ['android', 'mediandk']},
 ...
 'vvc_decoder': {'select': ['cabac', 'cbs_h266', 'golomb', 'videodsp']},
